...
export const languageSettingsItems: SettingItem[] = [
    ...
    // Translator Base
    {
        ...
        options: {
            selectOptions: [
                ...
                { value: 'zh-TW', labelKey: 'languageChineseTraditional', condition: (ctx) => ctx.db.translatorType === 'google' },
                { value: 'fa', labelKey: 'languagePersian', condition: (ctx) => ctx.db.translatorType === 'google' },
                ...
                { value: 'ms', labelKey: 'languageMalay' },
...

    {
        ...
        options: {
            selectOptions: [
                ...
                { value: 'llm', labelKey: 'auxiliaryModel' },
...

    {
        ...
        options: {
            selectOptions: [
                { value: 'auto', labelKey: 'languageAutomatic' },
