<script lang="ts">
    import { AccessibilityIcon, ActivityIcon, PackageIcon, BotIcon, BoxIcon, CodeIcon, ContactIcon, LanguagesIcon, MonitorIcon, Sailboat, UserIcon, CircleXIcon, KeyboardIcon, SparkleIcon, WandSparklesIcon } from "@lucide/svelte";
    ...
    import ResponseTransformerSettings from "./Pages/ResponseTransformerSettings.svelte";
            ...
            >
                ...
                {#if !$isLite}
                    ...
                    <button class="flex gap-2 items-center hover:text-textcolor"
                        ...
                        <WandSparklesIcon />
                        <span>{language.responseTransformer}</span>
                    </button>
                    <button class="flex gap-2 items-center hover:text-textcolor"
