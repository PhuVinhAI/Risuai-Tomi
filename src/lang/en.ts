export const languageEnglish = {
    ...
    packerWriter: "Context Packager–Writer",
    packerWriterPageDesc: "The first turn goes directly to Writer. Later turns use a packer to select only older-history facts needed alongside the latest reply.",
    packerWriterEnabled: "Enable Context Packager–Writer",
    packerPreset: "Context Packager Preset",
    writerPreset: "Writer Preset",
    packerWriterNoPresets: "No preset has this role yet. Set it under Prompt, or press + to create one.",
    packerWriterRole: "Packager–Writer Role",
    packerWriterRoleDesc: "Applies to the selected preset. The packer selects relevant old context; the Writer produces the reply.",
    packerWriterRoleNone: "None",
    packerWriterRolePacker: "Context Packager",
    ...
    packerWorking: "Packaging relevant context…",
    packerWriterLog: "Debug Log",
    packerWriterLogEnabled: "Write debug log",
    packerWriterLogWarning: "The log stores your chat content in plain text, unencrypted. Do not share the file.",
    packerWriterLogDownload: "Download log",
    packerWriterLogClear: "Clear log",
    packerWriterLogEmpty: "Log is empty",
    packerWriterPacketCacheSize: "Packet cache size (turns)",
    packerPacket: "Relevant Context Packet",
