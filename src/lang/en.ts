export const languageEnglish = {
    ...
    directorWriterPageDesc: "One model reads the whole context and writes a scene packet; a second model receives only that packet and writes the reply.",
    directorWriterPresetSection: "Role of the selected preset",
    directorWriterEnabled: "Enable Director–Writer",
    directorPreset: "Director Preset",
    writerPreset: "Writer Preset",
    directorWriterNoPresets: "No preset has this role yet. Set it under Prompt, or press + to create one.",
    directorWriterRole: "Director–Writer Role",
    directorWriterRoleDesc: "Applies to the preset you have selected. Picking a role reveals that role's prompt.",
    directorWriterRoleNone: "None",
    directorWriterRoleDirector: "Director",
    directorWriterRoleWriter: "Writer",
    directorRolePrompt: "Director Prompt",
    writerRolePrompt: "Writer Prompt",
    packetSchema: "Packet Schema",
    packetSchemaHeader: "Header",
    packetSchemaDescription: "What the Director must return here",
    packetSchemaRequired: "Required",
    packetSchemaReset: "Reset to defaults",
    directorRerollMode: "On Reroll",
    directorRerollModeWriter: "Rerun Writer only (cheap)",
    directorRerollModeBoth: "Rerun Director too (costs another call)",
    directorWorking: "Directing…",
    directorWriterLog: "Debug Log",
    directorWriterLogEnabled: "Write debug log",
    directorWriterLogWarning: "The log stores your chat content in plain text, unencrypted. Do not share the file.",
    directorWriterLogDownload: "Download log",
    directorWriterLogClear: "Clear log",
    directorWriterLogEmpty: "Log is empty",
    directorWriterPacketCacheSize: "Packet cache size (turns)",
    directorPacket: "Director Packet",
    ...
    characterTranslation: "Vietnamese Card Translation",
    characterTranslationSettings: "Character-card translation",
    characterTranslationSettingsDescription: "Shared AI and batching settings used by greeting and full-card translation.",
    characterTranslationAIPreset: "AI Preset",
    characterTranslationBatchSize: "Fields per request",
    characterTranslationRequestCharLimit: "Source characters per request",
    characterTranslationConcurrency: "Parallel requests",
    characterTranslationNoHardLimit: "These values have no hard maximum. Large values may exceed the selected provider's limits.",
    translateGreetingToVietnamese: "Translate Greeting",
    translateCharacterToVietnamese: "Translate Character + World",
    characterTranslationAllConfirm:
        "Translate all character prose, alternate greetings, and character lore into Vietnamese? Technical keys, assets, variables, and scripts will remain unchanged.",
    characterTranslationNoPreset: "Select a valid AI preset before translating.",
    characterTranslationNothing: "There is no text to translate.",
    characterTranslationComplete: "Translated {count} text fields into Vietnamese.",
    characterTranslationPause: "Pause",
    characterTranslationPausing: "Pausing...",
    characterTranslationPaused: "Paused",
    characterTranslationResume: "Resume",
    characterTranslationFailed: "Translation failed —",
    characterTranslationBatchProgress: "batch {current}/{total} · {translated}/{fields} fields",
    ...
    getMore: "Get More",
    failedToLoadHub: "Failed to load RisuRealm.",
    relatedLinks: "Related Links",
    website: "Website",
    email: "Email",
    relatedDiscordDesc: "Join our Discord server to chat with other users and the developer.",
    relatedWebsiteDesc: "Visit the project's official website.",
    relatedGitHubDesc: "View the source code and contribute to the project.",
    relatedEmailDesc: "Contact the developer directly.",
    realmLoginRequired: "You must log in to a RisuAI account before uploading to RisuRealm.",
    realmLoginHint: "You can log in under Settings → Account.",
    shareCharacterToRealm: (name: string) => `Share ${name} to RisuRealm`,
    realmCreatorNotesDesc: "This description appears in search results and when someone first opens the character.",
    realmCreatorNotesMinLength: "Enter at least 20 characters.",
    realmTagsDesc: "Tags make the character easier to find. Use Latin letters and separate tags with commas.",
    showAuthorId: "Show author ID",
    anonymized: "Anonymous",
    safeContent: "Safe",
    update: "Update",
    uploadNew: "Upload as new",
    realmNsfwWarning: "Grotesque content and NSFW content involving underage characters are prohibited.",
    realmCreatorNotesEnglishTooShort: "The English creator note must contain at least 10 characters.",
    realmCreatorNotesEnglishLatinOnly: "The English creator note may only contain Latin-1 characters.",
    uploadToRealm: "Upload to RisuRealm",
    realmUploadSuccess: (url: string) => `## Upload successful\n\nYour character was uploaded to RisuRealm.\n\n\`\`\`\n${url}\n\`\`\``,
    newFolder: "New Folder",
    resetDefaultImage: "Reset to default image",
    selectImageFile: "Select image file",
    welcomeToRisuAI: "Welcome to RisuAI!",
    selectBotToStart: "Select a character to start chatting",
    back: "Back",
    hordeLoading: "Loading...",
    performanceAuto: "Performance: Auto",
    ...
    tosAcceptPrefix: "To continue, you must accept the",
    tosAnd: "and",
    tosLegacyUntil: (date: string) => `You may continue using RisuAI under the previous terms until ${date}.`,
    saying: "Saying",
    size: "Size",
    time: "Time",
    timing: "Timing",
    ...
    inactive: "Inactive",
    useRealmToSharePreset: "Use RisuRealm to share this preset. Presets containing images or Regex Scripts cannot currently be exported.",
    optionDefault: "Default",
    optionLow: "Low",
    optionMedium: "Medium",
    optionHigh: "High",
    optionExtraHigh: "Extra high",
    optionMinimal: "Minimal",
    optionAdaptive: "Adaptive",
    optionBudgetManualTokens: "Budget (manual tokens)",
    optionOffDoNotSend: "Off (do not send)",
    optionViaSound: "Via sound",
    ...
    standardRisu: "Standard Risu",
    mobileChat: "Mobile chat",
    customHtml: "Custom HTML",
    custom: "Custom",
    customJinja: "Custom (Jinja)",
    ...
    intonationScale: "Intonation scale",
    customVoiceSeed: "Custom voice seed",
    voice: "Voice",
    advancedOpenAIEndpoint: "Advanced (OpenAI-compatible endpoint)",
    baseUrl: "Base URL",
    apiKeyOverridesGlobal: "API key (overrides global setting)",
    responseFormat: "Response format",
    noModel: "No model",
    volume: "Volume",
    useAutoPath: "Use automatic path",
    referenceAudioPath: "Reference audio path (for example: C:/Users/user/Downloads/GPT-SoVITS-v2-240821)",
    useLongAudio: "Use long audio",
    textLanguage: "Text language",
    useReferenceAudioScript: "Use reference audio script",
    referenceAudioScript: "Reference audio script",
    referenceAudioLanguage: "Reference audio language",
    multiLanguageMixed: "Multilingual mixed",
    multiLanguageMixedCantonese: "Multilingual mixed (Cantonese)",
    chineseEnglishMixed: "Chinese-English mixed",
    japaneseEnglishMixed: "Japanese-English mixed",
    cantoneseEnglishMixed: "Cantonese-English mixed",
    koreanEnglishMixed: "Korean-English mixed",
    languageCantonese: "Cantonese",
    textSplitMethod: "Text split method",
    textSplitNone: "Cut 0 (no splitting)",
    textSplitFourSentences: "Cut 1 (split every 4 sentences)",
    textSplitFiftyCharacters: "Cut 2 (split every 50 characters)",
    textSplitChinesePeriods: "Cut 3 (split by Chinese periods)",
    textSplitEnglishPeriods: "Cut 4 (split by English periods)",
    textSplitPunctuation: "Cut 5 (split by various punctuation marks)",
    notSelected: "Not selected",
    modelFetchError: "An error occurred while fetching the models.",
    chunkLength: "Chunk length",
    normalize: "Normalize",
    ttsAutoPathWarning: "If this is not set to Auto, importing from another operating system or browser may not work correctly.",
    modificationType: "Modification type",
    normalFlag: "Standard flag",
    orderFlag: "Order flag",
    customFlag: "Custom flag",
    importCharacterFromUrl: "Import character from URL or ID",
