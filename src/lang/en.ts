export const languageEnglish = {
    ...
    responseTransformerPageDesc: "After the active preset finishes a reply, an optional second preset rewrites that draft using only its Transformer system prompt.",
    responseTransformerEnabled: "Enable Response Transformer",
    responseTransformerPreset: "Transformer Preset",
    responseTransformerPresetDesc: "The Transformer uses this preset's complete model parameters, streaming and reasoning settings. Its main prompt, jailbreak and chat context are not sent.",
    responseTransformerNoPresets: "No enabled Transformer preset has a prompt yet. Configure one under Prompt, or press + to create one.",
    responseTransformerPresetRole: "Response Transformer",
    responseTransformerPresetRoleDesc: "Allow the selected preset to rewrite completed responses when chosen in Transformer settings.",
    responseTransformerPresetEnabled: "Use this preset as a Transformer",
    responseTransformerPrompt: "Transformer System Prompt",
    responseTransformerModel: "Transformer Model",
    responseTransformerError: "Transformer Error",
    responseTransformerWorking: "Transforming response…",
